...
>
> **数据资源**: 扩充主表 `augmented_yield_master.csv`（1,786 行，面板列 1,552 网格非空）作为数据资源层支撑第二目标复检与管理假说检验，详见「数据资源」一节与 `Outputs/reports/data_augmentation_report_stamen.html`
...
1. **随机 CV 比空间分块 CV 虚高 pooled R² 0.020-0.061**（折级均值口径 0.036-0.088）——空间自相关导致的乐观偏差被量化证实，两种口径均标注
...
│   ├── figures/main/         # 出版级图表（fig01-13，诊断线 01-08 + 250m 线 09-13，600dpi png+tiff）
